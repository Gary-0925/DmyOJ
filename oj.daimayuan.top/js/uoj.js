...
function getUserLink(username, rating, tag, addSymbol) {
	...
	if (rating < 5000 || rating >= 10000)
		...
		text += '<span style="color: rgb(0, 0, 0);">' + username.substring(1, username.length) + '</span>';
	if (tag == null || tag == undefined)
		return '<a class="uoj-username" href="/oj.daimayuan.top/user.html?#' + username + '" style="color:' + getColOfRating(username, rating) + ';' + ((rating == 0) ? (' font-weight: 400;') : ("")) + '">' + text + '</a>';
	return '<a class="uoj-username" href="/oj.daimayuan.top/user.html?#' + username + '" style="color:' + getColOfRating(username, rating) + ';' + ((rating == 0) ? (' font-weight: 400;') : ("")) + '">' + text + '</a> <button onclick="location.href=\'/oj.daimayuan.top/official/mark text/1.html\';" class="uoj-usertag" style="background-color: ' + getColOfTagBack(username, rating) + '; border: 1px ' + getColOfTagBord(username, rating) + ' solid;' + ((rating == 0) ? 'color: black; ' : '') + '">' + tag + '</button>';
}
...
top_dock_text += '<li class="nav-item"><a class="nav-link" href="/oj.daimayuan.top/problems.html"><span class="glyphicon glyphicon-list-alt"></span> 题库</a></li>';
top_dock_text += '<li class="nav-item"><a class="nav-link" href="/oj.daimayuan.top/submissions.html"><span class="glyphicon glyphicon-tasks"></span> 提交记录</a></li>';
top_dock_text += '<li class="nav-item"><a class="nav-link" href="/oj.daimayuan.top/contests.html"><span class="glyphicon glyphicon-stats"></span> 比赛</a></li>';
top_dock_text += '<li class="nav-item"><a class="nav-link" href="/oj.daimayuan.top/courses.html"><span class="glyphicon glyphicon-education"></span> 课程</a></li>';
top_dock_text += '<li class="nav-item"><a class="nav-link" href="/oj.daimayuan.top/note.html"><span class="glyphicon glyphicon-book"></span> Note<sup style="color:red;"><i>new</i></sup></a></li>';
...
if (localStorage.getItem("uoj-username") == "封禁帐号")
	top_dock_text = '<ul class="nav navbar-nav mr-auto"><li class="nav-item"><a class="nav-link" href="/oj.daimayuan.top/unseal.html">申请解封<sup style="color:red;"><i>申请即解封</i></sup></a></li></ul>';
top_dock.innerHTML = top_dock_text;


function input_users() {
	var url = "/oj.daimayuan.top/courses.html";
...
function input_problems() {
	var url = "/oj.daimayuan.top/problem";
...
linkcss.href = "/oj.daimayuan.top/css/uoj.css";
linkcss.media = "all";
document.getElementsByTagName("head")[0].appendChild(linkcss);

// LINK
var navbar_brand = document.querySelector(".navbar-brand");
navbar_brand.href = "/oj.daimayuan.top.html";
...
var fr_dm = '<li role="presentation"><a class="dropdown-item" id="my_chat" href="/oj.daimayuan.top/user.html???#' + localStorage.getItem("uoj-username") + '">个人信息</a></li>\n							<li role="presentation"><a class="dropdown-item" href="/oj.daimayuan.top/user/system-msg.html">系统消息&nbsp;&nbsp;</a></li>';
// ACTIVITY
if (!localStorage.getItem("uoj-user_" + localStorage.getItem("uoj-username") + "_gler") || localStorage.getItem("uoj-username") == localStorage.getItem("uoj-super_gler-user")) fr_dm += '\n						<li role="presentation"><a class="dropdown-item" href="/oj.daimayuan.top/act/uoj_manage.html">✨志愿者管理员活动</a></li>';
//------------------------------------------------------------
if (Number(localStorage.getItem("uoj-user_" + localStorage.getItem("uoj-username") + "_gler")) > 0)
	fr_dm += '\n						<li role="presentation"><a class="dropdown-item" href="/oj.daimayuan.top/edit/manage.html">系统管理&nbsp;&nbsp;</a></li>';
if (localStorage.getItem("uoj-username") != null && localStorage.getItem("uoj-super_gler-user") == localStorage.getItem("uoj-username"))
	fr_dm += '\n						<li role="presentation"><a class="dropdown-item" href="/oj.daimayuan.top/edit/domain.html">域管理&nbsp;&nbsp;</a></li>';
